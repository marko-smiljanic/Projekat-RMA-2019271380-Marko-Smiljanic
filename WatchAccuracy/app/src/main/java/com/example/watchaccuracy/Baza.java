...
public class Baza extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL2 = String.format("CREATE TABLE IF NOT EXISTS %s (%s INTEGER PRIMARY KEY AUTOINCREMENT, %s DATETIME, %s DATETIME, %s DATETIME, %s DATETIME, %s DATETIME, %s DATETIME, %s DATETIME, %s TEXT, %s INTEGER);",
